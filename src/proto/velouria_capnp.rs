...
pub mod request {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_changes(&mut self, value: crate::proto::velouria_capnp::changes_params::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 1);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_changes(self, ) -> crate::proto::velouria_capnp::changes_params::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 1);
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 48] = [
      ...
      ::capnp::word(108, 111, 117, 114, 105, 97, 46, 99),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        1 => <crate::proto::velouria_capnp::changes_params::Owned as ::capnp::introspect::Introspect>::introspect(),
  ...
  pub type WhichReader<'a,> = Which<::capnp::Result<crate::proto::velouria_capnp::changes_params::Reader<'a>>>;
  pub type WhichBuilder<'a,> = Which<::capnp::Result<crate::proto::velouria_capnp::changes_params::Builder<'a>>>;
}
...
pub mod changes_params {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 35] = [
      ...
      ::capnp::word(110, 103, 101, 115, 80, 97, 114, 97),
...
pub mod response {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_status(&mut self, value: crate::proto::velouria_capnp::status::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 0);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_status(self, ) -> crate::proto::velouria_capnp::status::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 0);
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), 0)
    }
    #[inline]
    ...
    #[inline]
    pub fn set_changes(&mut self, value: crate::proto::velouria_capnp::changes_result::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 1);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_changes(self, ) -> crate::proto::velouria_capnp::changes_result::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 1);
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), 0)
    }
    #[inline]
  ...
  mod _private {
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::proto::velouria_capnp::status::Owned as ::capnp::introspect::Introspect>::introspect(),
        1 => <crate::proto::velouria_capnp::changes_result::Owned as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
  ...
  pub type WhichReader<'a,> = Which<::capnp::Result<crate::proto::velouria_capnp::status::Reader<'a>>,::capnp::Result<crate::proto::velouria_capnp::changes_result::Reader<'a>>>;
  pub type WhichBuilder<'a,> = Which<::capnp::Result<crate::proto::velouria_capnp::status::Builder<'a>>,::capnp::Result<crate::proto::velouria_capnp::changes_result::Builder<'a>>>;
}
...
pub mod changes_result {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_changes(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::proto::velouria_capnp::change::Owned>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_changes(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::proto::velouria_capnp::change::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_changes(&mut self, value: ::capnp::struct_list::Reader<'a,crate::proto::velouria_capnp::change::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_changes(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::proto::velouria_capnp::change::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 53] = [
      ...
      ::capnp::word(108, 111, 117, 114, 105, 97, 46, 99),
      ::capnp::word(97, 112, 110, 112, 58, 67, 104, 97),
      ::capnp::word(110, 103, 101, 115, 82, 101, 115, 117),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        1 => <::capnp::struct_list::Owned<crate::proto::velouria_capnp::change::Owned> as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
...
pub mod status {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ...
      ::capnp::word(112, 114, 111, 116, 111, 47, 118, 101),
      ::capnp::word(108, 111, 117, 114, 105, 97, 46, 99),
      ::capnp::word(97, 112, 110, 112, 58, 83, 116, 97),
